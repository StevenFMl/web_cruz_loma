  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
        scrolled
          ? 'bg-[#0a0604]/95 backdrop-blur-md border-b border-[#3a2b1f]/80 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.6)]'
    ...
    >
      <div className={`w-full px-6 md:px-10 lg:px-16 mx-auto flex items-center justify-between transition-all duration-700 ${
        ...
        <nav className="hidden md:flex flex-1 justify-center items-center gap-10 lg:gap-14 self-center">
          {navLinks.map((link, i) => (
            <motion.a
              ...
              className="relative font-gotham text-xs lg:text-[13px] tracking-[0.32em] text-[#d4c5a8]/85 hover:text-[#ede0c4] transition-colors duration-700 uppercase whitespace-nowrap group font-bold"
            >
              {link.label}
        ...
        >
          <a
            href="#cervezas"
            className="hidden md:inline-flex items-center gap-3 px-6 py-2.5 font-gotham text-xs lg:text-[13px] tracking-[0.3em] text-[#ede0c4] uppercase border-2 border-[#c8782a]/50 hover:border-[#c8782a] hover:text-[#1a1410] hover:bg-[#c8782a] transition-all duration-700 whitespace-nowrap font-bold"
          >
            Descubrir
          </a>
          ...
          >
            <nav className="flex flex-col gap-1 items-stretch w-full max-w-md">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="font-ganache text-3xl text-[#ede0c4] hover:text-[#c8782a] transition-colors duration-500 w-full text-left py-5 border-b border-[#3a2b1f] flex items-center justify-between group"
                >
            ...
            >
              <a
                href="#cervezas"
                onClick={() => setMenuOpen(false)}
                className="block px-8 py-4 w-full text-center font-gotham text-sm tracking-[0.3em] text-[#1a1410] uppercase bg-[#c8782a] hover:bg-[#ede0c4] transition-colors duration-700 font-bold border-2 border-[#823914]"
              >
